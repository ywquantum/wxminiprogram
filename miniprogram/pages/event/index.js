import { requestToken } from "../../http/request";
import {
    putWarnMsg,
...
Component({
    ...
    pageLifetimes: {
        ...
        show: function () {
            this.getTableList(
                this.data.containerMenuList == 0
                    ? 1
                    : this.data.containerMenuList == 1
                    ? 2
                    : 3
            );
        },
    ...
    methods: {
        ...
        eventSwitch(e) {
            ...
            wx.navigateTo({
                url:
                    "../../eventpage/pages/eventDetails/eventDetails?baseData=" +
        ...
        getTableList(type) {
            let that = this;
            requestToken(`alarm?status=${type}&order=1&page=0&qiye_user_id=${app.globalData.userId}`, "get", {})
                .then((res) => {
                    // console.log(res);
                    if (res.code == 0) {
                        if (type == 1 || type == 2) {
